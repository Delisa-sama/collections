...
// FindFirstOfC ищет первый элемент из диапазона [begin, end),
// который также содержится в диапазоне [sBegin, sEnd), используя пользовательский компаратор.
...
// FindFirstOf ищет первый элемент из диапазона [begin, end),
// который также содержится в диапазоне [sBegin, sEnd), используя оператор сравнения ==.
// Функция возвращает итератор на найденный элемент и булево значение, указывающее на успех поиска.
//
// Параметры:
// - begin: итератор, указывающий на начало первого диапазона.
...
// FindFirstOfIf ищет первый элемент из диапазона [begin, end),
// который также содержится в диапазоне [sBegin, sEnd), для которого предикат возвращает true.
// Функция возвращает итератор на найденный элемент и булево значение, указывающее на успех поиска.
//
// Параметры:
// - begin: итератор, указывающий на начало первого диапазона.
