...
Библиотека containers предоставляет набор [контейнеров](#контейнеры), [адаптеров](#адаптеры), [итераторов](ITERATORS.md) и [алгоритмов](ALGORITHMS.md) для работы с коллекциями в языке Go.
